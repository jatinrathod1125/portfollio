...
const Hero = () => {
  return (
    <section id="home" className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 dark:from-gray-900 dark:to-gray-800 pt-16 md:pt-20 transition-colors duration-300 w-full">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 py-12 md:py-20 max-w-full xl:max-w-[2000px] 2xl:max-w-[2000px]">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
          ...
          >
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 mb-8 leading-relaxed transition-colors duration-300">
              Enthusiastic and detail-oriented Full Stack Developer with 6 months of hands-on experience 
              in designing, developing, and maintaining web applications using Laravel, PHP, HTML, CSS, and JavaScript.
            </p>
